...
public class SQLLocalDatabaseDriverConfig extends SQLDatabaseDriverConfig<SQLLocalDatabaseDriverConfig> implements LocalDatabaseDriverConfig<SQLLocalDatabaseDriverConfig> {
    ...
    protected SQLLocalDatabaseDriverConfig(String name, Dialect dialect, String connectionString, boolean useSSL, boolean trustServerCertificate, String connectionCatalog,
        ...
        super(name, dialect, connectionString, useSSL, trustServerCertificate, connectionCatalog, connectionSchema, connectionReadOnly, connectionIsolationLevel,
    ...
    public SQLLocalDatabaseDriverConfig copy() {
        return new SQLLocalDatabaseDriverConfig(this.name, this.dialect, this.connectionString, this.useSSL, this.trustServerCertificate, this.connectionCatalog
