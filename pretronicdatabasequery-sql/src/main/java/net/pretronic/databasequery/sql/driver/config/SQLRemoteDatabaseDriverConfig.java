...
public class SQLRemoteDatabaseDriverConfig extends SQLDatabaseDriverConfig<SQLRemoteDatabaseDriverConfig> implements RemoteDatabaseDriverConfig<SQLRemoteDatabaseDriverConfig> {
    ...
    protected SQLRemoteDatabaseDriverConfig(String name, Dialect dialect, String connectionString, boolean useSSL, boolean trustServerCertificate, String connectionCatalog
        ...
        super(name, dialect, connectionString, useSSL, trustServerCertificate, connectionCatalog, connectionSchema
    ...
    public SQLRemoteDatabaseDriverConfig copy() {
        return new SQLRemoteDatabaseDriverConfig(this.name, this.dialect, this.connectionString, this.useSSL, this.trustServerCertificate, this.connectionCatalog
